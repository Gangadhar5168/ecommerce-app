...
public class InventoryController {
    ...
    @PutMapping("/increase")
    public ResponseEntity<InventoryResponse> increaseInventory(@RequestBody UpdateInventoryRequest request){
        InventoryResponse response = inventoryService.increaseInventory(request);
        return ResponseEntity.ok(response);
    }

    @PutMapping("/decrease")
    public ResponseEntity<InventoryResponse> decreaseInventory(@RequestBody UpdateInventoryRequest request){
